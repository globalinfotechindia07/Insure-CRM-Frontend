...
const AddBranchSettings = () => {
  ...
  const getLogoUrl = (logoPath) => {
    ...
    if (logoPath.startsWith('/uploads')) {
      return `${STATIC_BASE_URL}${logoPath}`;
      // return `https://api.jpinsurancebrokers.co.in${logoPath}`;
                    ...
                    {branchList.length === 0 ? (
                      ...
                      branchList.map((branch) => (
                        <TableRow key={branch._id}>
                          {/* Logo */}
                          <TableCell>
                            {(branch.branchLogo || branch.companyLogo) ? (
                              <img 
                                src={getLogoUrl(branch.branchLogo || branch.companyLogo)} 
                                alt={branch.branchName || branch.companyName}
                                style={{
                                  width: 50,
                                  height: 50,
                                  objectFit: 'contain',
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                              ...
                              {branch.websiteLink && (
                                <Typography variant="caption">
                                  ...
                                  <a href={branch.websiteLink.startsWith('http') ? branch.websiteLink : `https://${branch.websiteLink}`} target="_blank" rel="noopener noreferrer">
                                    Website
                                  </a>
                                </Typography>
                              )}
                            ...
                            <Box sx={{ display: 'flex', gap: 1 }}>
                              ...
                              {(branchSettingPermission.Delete === true || isAdmin) && (
                                <IconButton
                                  size="small"
                                  color="error"
                                  onClick={() => handleDeleteClick(branch._id, branch.branchName || branch.companyName)}
                                  title="Delete Branch"
                                >
...
export default AddBranchSettings;
