...
function Documentation ({ setFormData, setIsAllFormsValidate, formData }) {
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
        ...
        >
          <TextField
            ...
            sx={{ marginBottom: 2 }}
          />
          <Button variant='contained' color='primary' fullWidth onClick={handleAddCustomField}>
            Add Document
          </Button>
        </Box>
      </Modal>
