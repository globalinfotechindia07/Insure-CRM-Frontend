...
const AddRole = ({ handleClose, getData }) => {
  ...
  const handleSubmitData = async (e) => {
    ...
    if (inputData.employeeRole === "") {
      setError((prev) => {
        return {...prev, employeeRole: "role is required"}
      })
    }
    if (inputData.employeeRole !== "") {
    await post('employee-role',inputData)
        .then(() => {
          setInputData({
            employeeRole: "",
          });
  ...
  return (
    <div className="modal">
      <h2 className="popupHead">Add Employee Role</h2>
