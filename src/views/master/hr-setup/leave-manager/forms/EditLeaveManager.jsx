...
const EditLeaveManager = ({ handleClose, getData, editData }) => {
  const [inputData, setInputData] = useState({
    typeOfLeave: editData?.typeOfLeave?._id || '',
    noOfLeaves: editData?.noOfLeaves || ''
  })
  ...
  const handleSubmitData = async e => {
    ...
    // API Call for Edit
    try {
      const response = await put(`leaveManager/${editData._id}`, { inputData })
  ...
  return (
    <div className='modal'>
      <h2 className='popupHead'>Edit Leave Manage</h2>
...
export default EditLeaveManager
