...
const EditService = ({ handleClose, getData, serverData, whichService, serviceName, editData }) => {
  ...
  const [inputData, setInputData] = useState({
    ...
    // patientPayeeId: editData.patientPayeeId,
    // payeeCategory:editData.payeeCategory,
    // payeeCategoryId:editData.payeeCategoryId,
    patientEncounter: editData.patientEncounter,
    detailServiceName: editData.detailServiceName,
    alternateServiceName: editData.alternateServiceName,
  ...
  function handleParentGroupChange(e) {
    ...
    if (selectedParentGroup) {
      setInputData((prev) => ({
        ...prev,
        payeeCategory: selectedParentGroup.payeeCategoryName,
        payeeCategoryId: id
      }));
    }
  }
  ...
  const handleSubmitData = async (e) => {
    ...
    try {
      const response = await put(`service-details-master/${editData._id}`, dataSend);
      if (response) {
