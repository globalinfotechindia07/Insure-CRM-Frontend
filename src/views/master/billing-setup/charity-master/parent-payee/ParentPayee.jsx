...
const ParentPayee = () => {
  ...
  const deleteData = async (id) => {
    await put(`charity/payee-group/delete/${id}`)
      .then(() => {
        fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    if (inputData.payeeParentName !== '' && inputData.parentGroup !== '' && inputData.parentGroupId !== '' && inputData.rateChart !== '') {
      await post('charity/payee-group', inputData)
        .then(() => {
          fetchData();
          setOpenRegistrationModal(false);
          setInputData({
  ...
  const handleEditSubmit = async (e) => {
    ...
    validation();
    if (inputData.payeeParentName !== '' && inputData.parentGroup !== '' && inputData.parentGroupId !== '' && inputData.rateChart !== '') {
      await put(`charity/payee-group/${data._id}`, inputData)
        .then(() => {
          fetchData();
          setOpenEditModal(false);
          toast({
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: '', alignItems: 'center' }}>
            ...
            <ImportExport
              ...
              api="charity/parent-payee/import"
            />
          </div>
        </div>
