...
const EditVitals = ({ handleClose, getData, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await put(`vital-master/edit/${editData?._id}`, { inputData });
      if (response?.success) {
  ...
  return (
    <div className="modal">
      <h2 className="popupHead">Edit Vitals</h2>
