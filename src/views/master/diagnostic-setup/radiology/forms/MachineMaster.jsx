...
import { Button, Modal, TablePagination, TextField, Typography } from '@mui/material';
import {
  Table,
  TableBody,
  TableCell,
...
const MachineMaster = () => {
  ...
  const deleteData = async (id) => {
    await put(`machine-radiology-master/delete/${id}`)
      .then((response) => {
        fetchData();
        toast.error(`${data.machineName} Machine Master deleted!!`);
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      await post('machine-radiology-master', inputData)
        .then((response) => {
          setOpenRegistrationModal(false);
          fetchData();
          setInputData({
  ...
  const handleEditSubmit = async (e) => {
    ...
    if (
      ...
      await put(`machine-radiology-master/${data._id}`, inputData)
        .then((res) => {
          setOpenEditModal(false);
          fetchData();
          // toast({
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: '', alignItems: 'center' }}>
          ...
          <ImportExport
            ...
            name="Radiology Machine/Method Master"
            fileValidationHandler={fileValidationHandler}
            exportDataHandler={exportDataHandler}
            api="machine-radiology-master/import"
          />
        </div>
