...
const TestMasterEditForm = ({ handleClose, fetchData, editData }) => {
  const [inputData, setInputData] = useState({
    testName: editData.testName || '',
    testCode: editData.testCode || '',
    subDepartment: editData.subDepartment || '',
    department: editData.department || '',
    departmentId: editData.departmentId || '',
    billGroup: editData.billGroup || '',
    billGroupId: editData.billGroupId || '',
  ...
  //if user selects numeric then description should empty
  //if user selects descriptive then testRange should empty
...
export default TestMasterEditForm
