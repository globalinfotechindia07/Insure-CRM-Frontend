...
const EditDose = ({ handleClose, getData, editData }) => {
  ...
  const handleSubmitData = async (e) => {
    ...
    if (inputData.dose !== "") {
      await put(`dose-master/${editData._id}`, inputData)
        .then(() => {
          setInputData({
            dose: "",
          });
          toast.success(`${editData.dose} Updated successfully`);
          handleClose();
          getData();
        })
        .catch((error) => {
  ...
  return (
    <div className="modal">
      <h2 className="popupHead">Update Dose</h2>
