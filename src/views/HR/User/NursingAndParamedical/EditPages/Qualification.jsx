...
function Qualification({ setValue, setStoredAllData, storedAllData }) {
  ...
  const fetchListOfCouncil = async () => {
   ...
   const submitQualification = async e => {
     ...
     if (true) {
         const response = await put(`nursingAndParamedical/qualification/${id}`, { qualificationForm })
   ...
   const submitAdditionalDetails = async e => {
     ...
     if (true) {
         const response = await put(`nursingAndParamedical/additionalDetails/${id}`, { additionalDetailsForm })
         if (response.success === true) {
           setStoredAllData(prev => ({
             ...prev,
