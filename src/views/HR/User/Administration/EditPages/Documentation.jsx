...
function EditDocumentation({ setStoredAllData, setIsAllFormsValidate, storedAllData, setValue }) {
  ...
  try {
    ...
    // Use your put wrapper (already parses JSON)
    const response = await put(`administrative/documents/${id}`, formData);
  ...
  //     // Append only files that are new uploads
  ...
  //     const updateDocuments = await put(`administrative/documents/${id}`,formData);
  ...
  //     const updateDocuments = await fetch(`${REACT_APP_API_URL}administrative/documents/${id}`, {
  //       method: 'PUT',
  //       body: formData
  //     })
                        ...
                        {files[fieldName] && toggleState[fieldName] ? (
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              if (file instanceof File) {
                                // New file, preview from browser
                                window.open(URL.createObjectURL(file), '_blank');
                              } else if (typeof file === 'string') {
                                // Old file from database
                                window.open(`${REACT_APP_API_URL}images/${file}`, '_blank');
                              }
                            }}
                          >
                            View File
