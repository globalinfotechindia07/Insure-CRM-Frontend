...
function Qualification({ setValue, setStoredAllData, storedAllData }) {
  ...
  const submitQualification = async (e) => {
    ...
    if (true) {
      const response = await put(`newConsultant/qualification/${id}`, { qualificationForm });
  ...
  const submitAdditionalDetails = async (e) => {
    ...
    if (true) {
      const response = await put(`newConsultant/additionalDetails/${id}`, { additionalDetailsForm });
      if (response.success === true) {
        setStoredAllData((prev) => ({
          ...prev,
