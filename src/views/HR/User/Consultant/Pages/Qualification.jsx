...
function Qualification({ setValue, setStoredAllData, storedAllData }) {
  ...
  const submitQualification = async (e) => {
    ...
    if (true) {
      if (storedAllData.submittedFormId) {
        const response = await put(`newConsultant/qualification/${storedAllData?.submittedFormId}`, { qualificationForm });
  ...
  const submitAdditionalDetails = async (e) => {
    ...
    if (true) {
      if (storedAllData.submittedFormId) {
        const response = await put(`newConsultant/additionalDetails/${storedAllData?.submittedFormId}`, { additionalDetailsForm });
        if (response.success === true) {
          setStoredAllData((prev) => ({
            ...prev,
